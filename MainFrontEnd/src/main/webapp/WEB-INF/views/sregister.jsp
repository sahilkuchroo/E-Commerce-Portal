 ...
 <body>
		...
		<h2 style="margin-left:210px;"><b>Registration</b></h2>
				...
				<sf:form modelAttribute="user"><br />
					...
					<tr>
					<td><sf:label path="s_comp_name">Company Name<sup>*</sup></sf:label></td>
					</tr>
					<tr>
					<td><sf:input path="s_comp_name" name="s_comp_name" placeholder="Company Name" class="form-control"/></td>
					<!-- to display Email validation messages -->
					<td><c:forEach items="${flowRequestContext.messageContext.getMessagesBySource('s_comp_name')}" var="err">
					  <div><span style="color:red;">${err.text}</span></div>
					</c:forEach></td>
					</tr>
					<tr>
